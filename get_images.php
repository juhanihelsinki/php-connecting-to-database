...
echo "<ahref='/kuvat/luettelo4.php?haku = $kuvanumero'><imgborder='0'src='/images/$vuosikymmen/images/$tiedostonimi'width='450'></a>";
echo "<h3>$otsikko</h3>";
echo "<p>$kuvailu</p>";
echo "<p>&nbsp;</p>";
...
else echo "<p><a href='index.php'>Kuvienhaku</a></p>";
echo "<br><br><br><strong>Kuvankäyttöoikeudet:</strong>Creativecommons<span><atarget='_blank'href='http://creativecommons.org/licenses/by/4.0/deed.fi'>CCBY4.0</a></span>";
if ($prev) echo "<pclass='irrallaan'><tablewidth='450'><tr><td><imgheight='0'width='85'src='/pics/250px.gif'></td><td><ahref='/kuvat/luettelo.php?haku=$prev'><imgwidth='30'src='/pics/success-previous-button.png'></a></td>";
...
echo "<p><p><hr></p></p>";
echo "<p><p><pclass='text_line'><ahref='/kuvat/luettelo4.php?haku = $kuvanumero'>(+)suurennakuva[$kuvanumero]</a></p></p>";
